...
fun main() {
    ...
    val siralama1 = ogrencilerListesi.sortedWith(compareBy { it.no }) // Veritabanlarında asc: ascend
    ...
    val siralama2 = ogrencilerListesi.sortedWith(compareByDescending { it.no }) // Veritabanlarında desc: descend
    ...
    val siralama3 = ogrencilerListesi.sortedWith(compareBy { it.ad }) // Veritabanlarında asc: ascend
    ...
    val siralama4 = ogrencilerListesi.sortedWith(compareByDescending { it.ad }) // Veritabanlarında desc: descend
